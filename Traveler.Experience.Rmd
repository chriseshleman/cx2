...
subset(share.Na, share.Na==0) 
```

Another 8 have some, but less than 21 percent, missing values: 
```{r}
subset(share.Na, share.Na>0 & share.Na<21) 
```

And a full 140 are missing exactly 21.636 percent of their observations! Here they are: 
```{r}
